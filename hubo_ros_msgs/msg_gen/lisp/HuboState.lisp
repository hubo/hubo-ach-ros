...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<HuboState>)))
  ...
  "4fcc49221fa083e1c5207aa30b4f35d7")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'HuboState)))
  "Returns md5sum for a message object of type 'HuboState"
  "4fcc49221fa083e1c5207aa30b4f35d7")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<HuboState>)))
  ...
  (cl:format cl:nil "HuboJointState[] joints~%HuboIMU imu~%HuboIMU left_foot~%HuboIMU right_foot~%HuboFT left_wrist~%HuboFT right_wrist~%HuboFT left_ankle~%HuboFT right_ankle~%~%================================================================================~%MSG: hubo_ros_msgs/HuboJointState~%string name~%float64 position~%float64 velocity~%float64 current~%float64 temperature~%int32 active~%int32 zeroed~%~%================================================================================~%MSG: hubo_ros_msgs/HuboIMU~%float64 x_acceleration~%float64 y_acceleration~%float64 z_acceleration~%float64 x_rotation~%float64 y_rotation~%float64 z_rotation~%~%================================================================================~%MSG: hubo_ros_msgs/HuboFT~%float64 Mx~%float64 My~%float64 Fz~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'HuboState)))
  "Returns full string definition for message of type 'HuboState"
  (cl:format cl:nil "HuboJointState[] joints~%HuboIMU imu~%HuboIMU left_foot~%HuboIMU right_foot~%HuboFT left_wrist~%HuboFT right_wrist~%HuboFT left_ankle~%HuboFT right_ankle~%~%================================================================================~%MSG: hubo_ros_msgs/HuboJointState~%string name~%float64 position~%float64 velocity~%float64 current~%float64 temperature~%int32 active~%int32 zeroed~%~%================================================================================~%MSG: hubo_ros_msgs/HuboIMU~%float64 x_acceleration~%float64 y_acceleration~%float64 z_acceleration~%float64 x_rotation~%float64 y_rotation~%float64 z_rotation~%~%================================================================================~%MSG: hubo_ros_msgs/HuboFT~%float64 Mx~%float64 My~%float64 Fz~%~%~%"))
