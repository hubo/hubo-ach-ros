/* Auto-generated by genmsg_cpp for file /home/wind/ROS_Packages/drc/hubo_ros_msgs/msg/HuboIMU.msg */
...
struct HuboIMU_ {
  ...
  typedef double _z_rotation_type;
  double z_rotation;
...
struct MD5Sum< ::hubo_ros_msgs::HuboIMU_<ContainerAllocator> > {
  ...
  {
    return "925b3f405942a88b584489a98554dcd8";
  }

  static const char* value(const  ::hubo_ros_msgs::HuboIMU_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0x925b3f405942a88bULL;
  static const uint64_t static_value2 = 0x584489a98554dcd8ULL;
};
...
struct Printer< ::hubo_ros_msgs::HuboIMU_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const  ::hubo_ros_msgs::HuboIMU_<ContainerAllocator> & v) 
  {
    ...
    s << indent << "z_rotation: ";
    Printer<double>::stream(s, indent + "  ", v.z_rotation);
  }
};
